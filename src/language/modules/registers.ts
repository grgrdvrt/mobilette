...
export const registers: Module = {
  set: {
    description:
      "Stores a value into a register, or sets the element of an array or color at a given index.",
    variants: [
      {
  ...
  print: {
    description: "Prints the given values to the console.",
    variants: [
      {
  ...
  get: {
    description:
      "Reads the element of an array or color at a given index into a register.",
    variants: [
      {
        params: [
          { type: types.ARRAY },
  ...
  pack: {
    description:
      "Replaces the contents of an array or color with the given values.",
    variants: [
      {
  ...
  unpack: {
    description:
      "Writes each element of an array or color into the given registers.",
    variants: [
      {
        params: [{ type: types.ARRAY }, { type: types.ANY, variadic: true }],
        effect: (params, env) => {
